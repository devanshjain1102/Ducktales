...
const Categories = () => {
  ...
  return (
    <div className="flex flex-col items-center mb-[30px]">
      ...
      <div
        className="grid grid-cols-4 gap-4 mt-8 rounded-[50%]"
      >
        {categories.map((category) => (
          <div className="flex flex-col items-center">
            <div
              ...
              className={`h-[300px] w-[300px] rounded-full bg-cover bg-center bg-no-repeat shadow-md flex items-center justify-center ${category.color}`}
            ></div>
